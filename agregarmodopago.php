            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form method="post" action="crearCliente.php">
                            ...
                            <div class="form-group">
                                <label for="telefono">Numero tarjeta de crédito:</label>
                                <input type="number" class="form-control" name="tarjeta_credito" required>
                            </div>
                            ...
                            <button type="submit" style="margin-top: 20px; margin-bottom: 10px;" class="btn btn-primary">Agregar tarjeta de credito</button>
